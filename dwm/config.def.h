...
static const char *shtdwn[] = { "shutdown", "now", NULL };
static const char *mediaplaypausecmd[] = { "mpc", "toggle", NULL };
static const char *medianextcmd[] = { "mpc", "next", NULL};
static const char *mediapreviouscmd[] = { "mpc", "prev", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_e,      spawn,          {.v = shtdwn } },
    { MODKEY,		                XK_o,      spawn,          {.v = passmenu } },
    { MODKEY|ShiftMask,             XK_s,      spawn,          SHCMD("import \"/tmp/$(date '+%Y-%m-%d-%T')-screenshot.png\"") },
